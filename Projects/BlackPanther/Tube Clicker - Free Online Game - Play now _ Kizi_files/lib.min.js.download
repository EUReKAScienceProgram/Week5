...
this.Template=this.Template||{},function(){"use strict";function e(e){return e.replace(/^\s+|\s+$/g,"")}Template.settings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g},Template.render=function(t,n,r){if(!t)throw new Error("Template not found");if(t=t.innerHTML,r===!0){if(void 0===window._)throw new Error('Unserscore is a dependancy if you want to use "Advanced mode"');_.templateSettings=Template.settings,t=_.template(t,n)}else t=t.replace(Template.settings.escape,function(t,r){return r=e(r),escape(void 0===n[r]?"":n[r])}),t=t.replace(Template.settings.interpolate,function(t,r){return r=e(r),void 0===n[r]?"":n[r]}),t=t.replace(Template.settings.evaluate,function(t,r){return r=e(r),n[r]});return t}}(),RandNum=function(){var e=(new Date).getTime();return function(){return e=e+2127912214+(e<<12)&4294967295,e=4294967295&(3345072700^e^e>>>19),e=e+374761393+(e<<5)&4294967295,e=4294967295&(e+3550635116^e<<9),e=e+265749701+(e<<3)&4294967295,e=4294967295&(3042594569^e^e>>>16),(268435455&e)/268435456}}(),function(){for(var e=document.querySelectorAll("video"),t=0;t<e.length;t++)e[t].addEventListener("ended",function(){document.webkitExitFullscreen&&document.webkitExitFullscreen(),document.mozCancelFullscreen&&document.mozCancelFullscreen(),document.exitFullscreen&&document.exitFullscreen()},!1)}(),function(){for(var e,t=function(){},n=["assert","clear","count","debug","dir","dirxml","error","exception","group","groupCollapsed","groupEnd","info","log","markTimeline","profile","profileEnd","table","time","timeEnd","timeStamp","trace","warn"],r=n.length,i=window.console=window.console||{};r--;)e=n[r],i[e]||(i[e]=t)}(),function(){function e(){if(t)return t;t=this;var n=this;return n.initialize=function(t){for(var r in t)n[r]=t[r],e[r]=t[r];for(var r in e)n[r]=e[r]},n.toString=function(){return"[object Context]"},n.initialize.apply(n,arguments),n}var t;e.getInstance=function(){return function(n){return t?t:new e(n)}}(),e.isMobile=function(){return function(){return"undefined"!=typeof window.orientation||e.isTouch()?!0:!1}}(),e.isTablet=function(){return function(){return e.isIPad()?!0:e.isMobile()&&e.getViewport().width>767?!0:!1}}(),e.isDesktop=function(){return function(){return"undefined"!=typeof window.orientation?!1:!0}}(),e.isTouch=function(){return function(){return!!("ontouchstart"in window)}}(),e.isIE=function(){return function(t){return void 0!==t?e.getIEVersion()===t?!0:!1:-1!==navigator.userAgent.indexOf("MSIE")||navigator.appVersion.indexOf("Trident/")>0}}(),e.isChrome=function(){return function(){var e=navigator.userAgent;return/Chrome/i.test(e)?!0:!1}}(),e.isFirefox=function(){return function(){var e=navigator.userAgent;return/Firefox/i.test(e)?!0:!1}}(),e.isSafariMobile=function(){return function(){var e=navigator.userAgent;return/Mobile(\/.*)? Safari/i.test(e)?!0:!1}}(),e.isSafari=function(){return function(){var t=navigator.userAgent;return e.isSafariMobile()?!1:/Safari/i.test(t)?/Chrome/i.test(t)?!1:!0:!1}}(),e.isAndroid=function(){return function(){var e=navigator.userAgent;return/Android/i.test(e)?!0:!1}}(),e.isIOS=function(){return function(){var e=navigator.userAgent;return/iP[ao]d|iPhone/i.test(e)?!0:!1}}(),e.isIPad=function(){return function(){var e=navigator.userAgent;return/iP[ao]d/i.test(e)?!0:!1}}(),e.isIPhone=function(){return function(){var e=navigator.userAgent;return/iPhone/i.test(e)?!0:!1}}(),e.getIEVersion=function(){return function(){var e=!1,t=/MSIE (\d+\.\d+);/.test(navigator.userAgent),n=!!navigator.userAgent.match(/Trident\/7.0/),r=navigator.userAgent.indexOf("rv:11.0");return t&&(e=Number(RegExp.$1)),-1!=navigator.appVersion.indexOf("MSIE 10")&&(e=10),n&&-1!=r&&(e=11),e}}(),e.getValue=function(){return function(e,n){if(t)return t[e]?t[e]:void 0!==n?n:!1;throw new Error("Context is not defined")}}(),e.getParameterByName=function(e){e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var t=new RegExp("[\\?&]"+e+"=([^&#]*)"),n=t.exec(location.search);return null==n?"":decodeURIComponent(n[1].replace(/\+/g," "))},e.ADSERVERS={NONE:"none",STANDARD:"Google Display Network or DoubleClick Standard",ADWORDS:"Google AdWords",DCM_RICH:"DoubleClick Studio",ADGEAR:"AdGear"};var n=e.ADSERVERS.STANDARD;e.setType=function(e){n=e},e.getType=function(){return n},window.Context=e}(),function(){function e(){function e(){if(Context.getType()===Context.ADSERVERS.DCM_RICH){var e=document.querySelectorAll("video");e&&Enabler.loadModule(studio.module.ModuleId.VIDEO,function(){for(var t=0;t<e.length;t++)studio.video.Reporter.attach("video"+t,e[t])}),Enabler.isPageLoaded?n():Enabler.addEventListener(studio.events.StudioEvent.PAGE_LOADED,n)}else n()}function n(){console.log("version -> "+t),Context.getType()==Context.ADSERVERS.NONE?(console.info("*** clicktag is deactivated -> AdServer can add clicktag all over the ad ***"),console.info("*** Ready for Google AdWords(or other AdServer) without clicktag ***")):console.info("*** Ready for "+Context.getType()+" ***"),init(),Context.isIOS()?setTimeout(function(){document.getElementById("ad").style.visibility="visible"},100):document.getElementById("ad").style.visibility="visible"}function r(){var e={},t=document.getElementsByTagName("meta");for(i=0;i<t.length;i++)e[t[i].getAttribute("name")]=t[i].getAttribute("content");return e}function o(e,t){if(c["ad.size"]||e&&t){var n={};if(e||t)n.width=e,n.height=t;else{var r=c["ad.size"].split(",");for(var i in r){var o=r[i].split("=");n[o[0]]=o[1]}}return document.getElementById("ad").style.width=n.width+"px",document.getElementById("ad").style.height=n.height+"px",n}throw new Error('meta tag "ad.size" is not defined')}function a(e,t){if(c["ad.border.color"]){if(!document.querySelector(".borders")){var n=document.head||document.getElementsByTagName("head")[0],r=".border {position: absolute;top:0; left:0;width:1px; height:1px;z-index: 9999999; background-color:#000000}",i=document.createElement("div");i.innerHTML="<p>x</p><style>"+r+"</style>",n.appendChild(i.childNodes[1]),d.addChild('<div class="borders">\n<div class="border border-top"></div>\n<div class="border border-right"></div>\n<div class="border border-bottom"></div>\n<div class="border border-left"></div>\n</div>')}for(var o=document.querySelectorAll(".border"),a=0;a<o.length;a++)o[a].style.backgroundColor=c["ad.border.color"];void 0==e&&(e=d.width()),void 0==t&&(t=d.height()),document.querySelector(".border-top").style.width=e+"px",document.querySelector(".border-right").style.height=t+"px",document.querySelector(".border-right").style.left=e-1+"px",document.querySelector(".border-bottom").style.width=e+"px",document.querySelector(".border-bottom").style.top=t-1+"px",document.querySelector(".border-left").style.height=t+"px"}}function u(){for(var e=document.getElementsByTagName("a"),t=0;t<e.length;t++)e[t].attached||(e[t].addEventListener("click",function(e){var t=e.target.getAttribute("data-type");t?onClickHref(e,t):onClickHref(e)}),e[t].attached=!0)}var d=this,c=r(),l=o();return d.initialize=function(){function t(e){return Context.getParameterByName("agclick_"+e)||Context.getParameterByName(e)}if(a(),u(),c["ad.clicktag"]&&"true"===c["ad.clicktag"]||!c["ad.clicktag"])if(window.Enabler)Context.setType(Context.ADSERVERS.DCM_RICH);else if(window.ExitApi)Context.setType(Context.ADSERVERS.ADWORDS);else{var r=t("clickTAG")||t("clickTag")||t("clicktag");r&&(Context.setType(Context.ADSERVERS.ADGEAR),window.clickTag=r)}else window.Enabler=null,window.ExitApi=null,Context.setType(Context.ADSERVERS.NONE);window.onload=function(){Context.getType()===Context.ADSERVERS.DCM_RICH?Enabler.isInitialized()?e():Enabler.addEventListener(studio.events.StudioEvent.INIT,e):n()}},d.width=function(){return l.width},d.height=function(){return l.height},d.DOMElement=function(){return document.getElementById("stage")},d.resizeTo=function(e,t){o(e,t),a(e,t)},d.pauseAllVideos=function(){for(var e=document.querySelectorAll("video"),t=0;t<e.length;t++)e[t].paused||e[t].pause()},d.addChild=function(e){var t=document.createElement("div");for(t.innerHTML=e;t.firstChild;)d.DOMElement().appendChild(t.firstChild);u()},d.removeChild=function(e){return d.DOMElement().parentNode.removeChild(e),!1},d.initialize.apply(d,arguments),d}var t="1.0.9";window.Stage=e}();var context=new Context,stage=new Stage;